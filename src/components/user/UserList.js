...
const UserList = () => {
    ...
    const getUserStats = (userId) => {
        ...
        const completedTodos = (user.todos || []).filter(todo => todo.completed).length || 0;
                ...
                <div style={{ padding: '16px' }}>
                    ...
                    >
                        ...
                        {users.map((user) => {
                            ...
                            const { userPosts, userAlbums, userTodos, completedTodos, pendingTodos } = getUserStats(id);
            ...
            >
                <Modal.Section>
                    ...
                    <TextField
                        ...
                        onChange={(value) => setSelectedUser({ ...selectedUser, website: value })}
                        autoComplete="off"
                    />
                    <TextField
                        label="Company"
                        value={selectedUser ? selectedUser.company : ''}
                        onChange={(value) => setSelectedUser({ ...selectedUser, company: value })}
                        autoComplete="off"
                    />
                    <TextField
                        label="Address"
